...
const About = () => {
  return (
  <div className="card lg:card-side bg-base-100 md:auto md:mr-5 md:mt-32" id='about'>
  <figure>
    <Image 
        src="/origamitree.png"  
        alt="origami tree"
        fill
        className='object-contain object-left p-28 invisible md:visible  xl:ml-20'
    />
    </figure>
  <div className="card-body xl:ml-[45rem]">
