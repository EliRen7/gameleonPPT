...
<section className="bg-white dark:bg-gray-900 md:ml-20">
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form  className="space-y-8" action="https://formcarry.com/s/z-NofMdhiD" method="POST" accept-charset="UTF-8">
          <div>
          ...
          <button type="submit" className='btn bg-sky-500 text-white'>Send</button>
      </form>
  </div>
</section>
